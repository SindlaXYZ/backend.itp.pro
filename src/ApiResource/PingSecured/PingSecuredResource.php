...
#[ApiResource(
    shortName             : 'Ping secured',
    operations            : [
        new Post(
            uriTemplate: '/ping/secured',
            description: 'Send secured ping and receive pong response',
            processor  : PingSecuredStateProcessor::class
        )
    ],
